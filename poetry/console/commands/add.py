...
class AddCommand(InstallerCommand, InitCommand):
    ...
    help = (
        ...
        "  - A git url with a sub-directory (<b>git+https://github.com/python-poetry/poetry.git#subdirectory=path_to_project</b>)\n"
        ...
        "  - A git SSH url with a subdirectory (<b>git+ssh://github.com/python-poetry/poetry.git#subdirectory=path_to_project</b>)\n"
